...
namespace AppWeb.Controllers
{
    public class VideoJuegosController(AppDbContext context) : Controller
    {
        ...
        // public async Task<IActionResult> Index(bool ultimos = false)
        // {
        //       var juegos = _context.Videojuegos.AsQueryable();

        //     if (ultimos)
        //     {
        //         juegos = juegos.
        //         OrderByDescending(j => j.FechaRegistro).Take(10);
        //     }
        ...
        public async Task<IActionResult> Edit(int id, Videojuego juego, IFormFile? archivoImagen)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                juegoBD.Clasificacion = juego.Clasificacion;
